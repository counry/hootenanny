...
[[coastlines]]
.Coastlines
image::Coastlines.png[Coastlines at two scales,scalewidth="50%"]
...
.Conflation Quality
image::GenericLineTestGraph.png[Random Forest vs. Generic Line Road Conflation Performance,scalewidth="50%"]
...
[[Conflation Speed]]
.Conflation Speed
image::GenericLineTestTimingGraph.png[Random Forest vs. Generic Line Road Conflation Timing,scalewidth="50%"]
#TODO: replace with MPL - #267
